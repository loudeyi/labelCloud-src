...
; "carry this box forward" (Ctrl+Shift+E): re-fit each frame, and how many frames
; one press writes. A short run keeps a bad prediction from piling up boxes: it
; still stops earlier when the object leaves the view.
